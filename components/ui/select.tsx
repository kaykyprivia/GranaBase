...
const SelectContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & { pinnedTop?: React.ReactNode }
>(({ className, children, pinnedTop, position = "popper", ...props }, ref) => (
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-border focus:text-text-primary",
