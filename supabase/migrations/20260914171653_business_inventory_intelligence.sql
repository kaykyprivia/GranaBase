...
-- Adds scalable inventory reads and recent-demand intelligence without changing
-- the authoritative stock projection in business_inventory_summary.

create index if not exists idx_business_movements_workspace_type_created_product
